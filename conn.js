...
mentions(`「 ANTILINK 」\n\n@${sender.split('@')[0]} Kamu mengirim link group, maaf kamu akan terkena bkick oleh bot`, [sender])
await sleep(3000)
...
const gurbot = '6285280407526@s.whatsapp.net'
...
var bg_lexxy = '6285280407526@s.whatsapp.net'
